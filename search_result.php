    ...
    <div class="container pb-5">
        ...
        <div class="row justify-content-center pt-3 ">
            <h4 class="text-center pb-5 pt-3 text-white">Search Results of "<span class="text-info"><?php echo "$search"; ?></span>"</h4>
                <?php
                //checking whether the value(search) whether that is alpha value or not like a,b,c,d or whether its numbered value or not. 
                //Speacial character, and blaknk space search wont be exist. 
                if (ctype_alpha($_POST['search']) || ctype_alnum($_POST['search'])) {
                    // the thing that we want to search is already in a variable above.
                    //the thing I want to search is checking whether its in title, description or category then value will be shown. 
