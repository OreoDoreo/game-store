 ...
 <div style="background: #000;">
    <div class="container pb-5">
        <div class="row justify-content-center pt-3 ">
            <h2 class="text-center pb-3 pt-3 text-white">Games & Consoles Manager</h2>
                <?php
                ...
                <div class="text-center"><a class="mt-3 mb-3 btn btn-success btn-lg" href="Games_add_form.php">Add Game or Consoles</a></div>
          </div>
     </div>		
  </div>
