...
<body>
 	...
 	<!-- Background Image -->
    <div class= "crop">
        <img src="img/frontpage_1.jpg" alt="">
    <div class="wrap">
      <br>
      <br>
      <br>
      ...
      <br>
        <div class="text-white text-center pb-5"> <h3 >Welcome to Element Gaming Store</h3></div>
            ...
            <form action="search_result.php" method="post">
                <div class="search">
                  <!-- taking input of search  then sending the result into search result-->
...
<br>
    ...
    <div class= "text-white"style="background: #000;">
        ...
        <div class="row justify-content-center pt-3 ">
            ...
            <!-- From games table selecting all the games whose exclusive and active true --> 
                <?php
                    $sql= 'SELECT * FROM games WHERE exclusive="true" AND active="true";';
                    // Result is now stored in result variable. 
                    $result = mysqli_query($connected, $sql); 
                        while ($games = mysqli_fetch_array($result)) {?>
                            <div class="col-lg-4 pb-4">
                               <div class="card bg-dark text-white card-fix">
                                 <!-- the image that i have saved in database is here --> 
                                 <!-- THe image that is in database that will be catched by $games[image] variable -->
                                  <?php  echo '<img class="card-img-top" src="img/',$games['image'],'" alt="" style="width: 100%; height:350px;">';?>
                                  <div class="card-body">
                                    <!-- Title part will catch and store--> 
                                     ...
                                     <!-- Here we are proceeding to order form as well as title and price also is also passed --> 
